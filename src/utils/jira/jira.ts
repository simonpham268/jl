...
if (require.main === module) {
    ...
    const mode = process.argv[3]; // 'details' for using getTicketDetails method

    if (!releaseVersion) {
        console.log('Usage: npx tsx src/utils/jira/jira.ts <release_version> [mode]');
        console.log('Example: npx tsx src/utils/jira/jira.ts 213');
        console.log('Example: npx tsx src/utils/jira/jira.ts 213 details');
        console.log('');
        console.log('Modes:');

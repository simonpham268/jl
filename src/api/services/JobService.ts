...
import type { Job, CreateJobRequest, CreateJobResponse, UpdateJobRequest } from '../models';
import { CREATE_JOB_REQUIRED_FIELDS } from '../models/Job';
...
export class JobService {
  ...
  async createJob(data: CreateJobRequest): Promise<ApiResponse<CreateJobResponse>> {
    const form = buildFormData(data, CREATE_JOB_REQUIRED_FIELDS);

...
# JoblogicAPIModelsQuoteMaterialCostResponse
...
```typescript
import type { JoblogicAPIModelsQuoteMaterialCostResponse } from ''
...
const example = {
  ...
  "uniqueId": null,
  "siteId": null,
} satisfies JoblogicAPIModelsQuoteMaterialCostResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsQuoteMaterialCostResponse

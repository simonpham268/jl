...
# JobLogicMicroserviceCoreContractQuoteCalloutLineResponse
...
```typescript
import type { JobLogicMicroserviceCoreContractQuoteCalloutLineResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JobLogicMicroserviceCoreContractQuoteCalloutLineResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JobLogicMicroserviceCoreContractQuoteCalloutLineResponse

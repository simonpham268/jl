...
```typescript
import type { JoblogicAPIModelsCreateTravelJobCostRequest } from ''
...
} satisfies JoblogicAPIModelsCreateTravelJobCostRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreateTravelJobCostRequest

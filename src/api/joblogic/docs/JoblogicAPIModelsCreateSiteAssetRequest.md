...
```typescript
import type { JoblogicAPIModelsCreateSiteAssetRequest } from ''
...
} satisfies JoblogicAPIModelsCreateSiteAssetRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreateSiteAssetRequest

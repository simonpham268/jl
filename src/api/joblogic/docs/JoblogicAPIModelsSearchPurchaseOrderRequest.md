...
```typescript
import type { JoblogicAPIModelsSearchPurchaseOrderRequest } from ''
...
} satisfies JoblogicAPIModelsSearchPurchaseOrderRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsSearchPurchaseOrderRequest

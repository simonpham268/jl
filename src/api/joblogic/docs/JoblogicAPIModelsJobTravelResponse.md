...
```typescript
import type { JoblogicAPIModelsJobTravelResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsJobTravelResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsJobTravelResponse

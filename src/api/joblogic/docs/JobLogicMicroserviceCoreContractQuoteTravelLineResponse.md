...
# JobLogicMicroserviceCoreContractQuoteTravelLineResponse
...
```typescript
import type { JobLogicMicroserviceCoreContractQuoteTravelLineResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JobLogicMicroserviceCoreContractQuoteTravelLineResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JobLogicMicroserviceCoreContractQuoteTravelLineResponse

...
```typescript
import type { JoblogicAPIModelsUpdateCGroupInvoicePaymentRequest } from ''
...
} satisfies JoblogicAPIModelsUpdateCGroupInvoicePaymentRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsUpdateCGroupInvoicePaymentRequest

...
```typescript
import type { JoblogicAPIModelsEngineerGetByIdResponse } from ''
...
} satisfies JoblogicAPIModelsEngineerGetByIdResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsEngineerGetByIdResponse

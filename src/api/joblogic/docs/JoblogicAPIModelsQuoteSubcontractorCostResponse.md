...
# JoblogicAPIModelsQuoteSubcontractorCostResponse
...
```typescript
import type { JoblogicAPIModelsQuoteSubcontractorCostResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsQuoteSubcontractorCostResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsQuoteSubcontractorCostResponse

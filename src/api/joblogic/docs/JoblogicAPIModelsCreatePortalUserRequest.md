...
```typescript
import type { JoblogicAPIModelsCreatePortalUserRequest } from ''
...
} satisfies JoblogicAPIModelsCreatePortalUserRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreatePortalUserRequest

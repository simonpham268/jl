...
```typescript
import type { JoblogicAPIModelsJobCalloutResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsJobCalloutResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsJobCalloutResponse

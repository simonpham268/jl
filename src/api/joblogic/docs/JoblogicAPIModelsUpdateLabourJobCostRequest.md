...
```typescript
import type { JoblogicAPIModelsUpdateLabourJobCostRequest } from ''
...
} satisfies JoblogicAPIModelsUpdateLabourJobCostRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsUpdateLabourJobCostRequest

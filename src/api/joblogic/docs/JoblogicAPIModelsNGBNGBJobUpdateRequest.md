...
# JoblogicAPIModelsNGBNGBJobUpdateRequest
...
```typescript
import type { JoblogicAPIModelsNGBNGBJobUpdateRequest } from ''
...
const example = {
  ...
  "notes": null,
  "assets": null,
} satisfies JoblogicAPIModelsNGBNGBJobUpdateRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsNGBNGBJobUpdateRequest

...
```typescript
import type { JoblogicAPIModelsUpdateMaterialJobCostRequest } from ''
...
} satisfies JoblogicAPIModelsUpdateMaterialJobCostRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsUpdateMaterialJobCostRequest

...
```typescript
import type { JoblogicAPIModelsJobSubcontractorResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsJobSubcontractorResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsJobSubcontractorResponse

...
# JoblogicAPIModelsAssetAdditionalDetails
...
```typescript
import type { JoblogicAPIModelsAssetAdditionalDetails } from ''
...
} satisfies JoblogicAPIModelsAssetAdditionalDetails
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsAssetAdditionalDetails

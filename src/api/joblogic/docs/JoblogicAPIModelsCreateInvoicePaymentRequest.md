...
```typescript
import type { JoblogicAPIModelsCreateInvoicePaymentRequest } from ''
...
} satisfies JoblogicAPIModelsCreateInvoicePaymentRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreateInvoicePaymentRequest

...
# JoblogicAPIModelsQuoteOtherCostResponse
...
```typescript
import type { JoblogicAPIModelsQuoteOtherCostResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsQuoteOtherCostResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsQuoteOtherCostResponse

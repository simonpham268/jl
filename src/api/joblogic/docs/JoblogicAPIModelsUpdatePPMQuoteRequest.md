...
```typescript
import type { JoblogicAPIModelsUpdatePPMQuoteRequest } from ''
...
} satisfies JoblogicAPIModelsUpdatePPMQuoteRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsUpdatePPMQuoteRequest

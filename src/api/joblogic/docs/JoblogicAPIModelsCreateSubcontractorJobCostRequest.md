...
```typescript
import type { JoblogicAPIModelsCreateSubcontractorJobCostRequest } from ''
...
} satisfies JoblogicAPIModelsCreateSubcontractorJobCostRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreateSubcontractorJobCostRequest

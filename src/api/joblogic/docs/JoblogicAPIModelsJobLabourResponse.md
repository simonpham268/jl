...
```typescript
import type { JoblogicAPIModelsJobLabourResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsJobLabourResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsJobLabourResponse

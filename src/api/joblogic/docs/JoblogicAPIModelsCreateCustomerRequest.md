...
```typescript
import type { JoblogicAPIModelsCreateCustomerRequest } from ''
...
} satisfies JoblogicAPIModelsCreateCustomerRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreateCustomerRequest

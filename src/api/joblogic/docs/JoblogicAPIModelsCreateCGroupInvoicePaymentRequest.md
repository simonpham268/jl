...
```typescript
import type { JoblogicAPIModelsCreateCGroupInvoicePaymentRequest } from ''
...
} satisfies JoblogicAPIModelsCreateCGroupInvoicePaymentRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsCreateCGroupInvoicePaymentRequest

...
```typescript
import type { JoblogicAPIModelsJobMileageResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsJobMileageResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsJobMileageResponse

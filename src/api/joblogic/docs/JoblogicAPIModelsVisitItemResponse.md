...
# JoblogicAPIModelsVisitItemResponse
...
```typescript
import type { JoblogicAPIModelsVisitItemResponse } from ''
...
const example = {
  ...
  "isEditable": null,
  "noAccess": null,
} satisfies JoblogicAPIModelsVisitItemResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsVisitItemResponse

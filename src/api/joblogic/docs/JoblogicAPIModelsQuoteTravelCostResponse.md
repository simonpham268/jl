...
# JoblogicAPIModelsQuoteTravelCostResponse
...
```typescript
import type { JoblogicAPIModelsQuoteTravelCostResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsQuoteTravelCostResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsQuoteTravelCostResponse

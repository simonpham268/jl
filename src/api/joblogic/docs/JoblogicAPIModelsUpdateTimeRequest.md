...
```typescript
import type { JoblogicAPIModelsUpdateTimeRequest } from ''
...
} satisfies JoblogicAPIModelsUpdateTimeRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsUpdateTimeRequest

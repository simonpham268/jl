...
# JoblogicAPIModelsQuoteItemApiForNGBResponse
...
`notes` | [Array&lt;JobLogicMicroserviceCoreContractQuoteNoteItemResponse&gt;](JobLogicMicroserviceCoreContractQuoteNoteItemResponse.md)
`assets` | Array&lt;number&gt;

## Example

```typescript
import type { JoblogicAPIModelsQuoteItemApiForNGBResponse } from ''
...
const example = {
  ...
  "notes": null,
  "assets": null,
} satisfies JoblogicAPIModelsQuoteItemApiForNGBResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsQuoteItemApiForNGBResponse

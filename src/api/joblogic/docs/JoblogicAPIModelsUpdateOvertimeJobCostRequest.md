...
```typescript
import type { JoblogicAPIModelsUpdateOvertimeJobCostRequest } from ''
...
} satisfies JoblogicAPIModelsUpdateOvertimeJobCostRequest
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsUpdateOvertimeJobCostRequest

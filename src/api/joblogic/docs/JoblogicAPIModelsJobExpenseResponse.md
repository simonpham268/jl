...
```typescript
import type { JoblogicAPIModelsJobExpenseResponse } from ''
...
const example = {
  ...
  "tagIds": null,
} satisfies JoblogicAPIModelsJobExpenseResponse
...
const exampleParsed = JSON.parse(exampleJSON) as JoblogicAPIModelsJobExpenseResponse
